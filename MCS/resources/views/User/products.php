        ...
        <div class="col-md-3 col-sm-2" >
             <div class="card-container manual-flip"  >
                <div class="card" style="">
                    <div class="front" style="height: 50px;" >
                    ...
                    <div class="back" style="height:240px;">
                       
                       
                            <div class="main" style="padding:50px;">
                                <p class="text-left">Name,<br> Prices,<br> Date published,<br> status</p>
                                
                            <button class="btn btn-simple" rel="tooltip" title="Get Back" onclick="rotateCard(this)">
