            ...
            <li class="treeview">
              <a href="#">
                ...
                <ul class="treeview-menu">
                  ...
                  </li><li><a href="/EquipmentPage"><i class="fa fa-circle-o"></i> Equipment</a></li>
                  <li><a href="/EventPage"><i class="fa fa-circle-o"></i> Event</a></li>
                  <li><a href="/LocationPage"><i class="fa fa-circle-o"></i> Location</a></li>
                  <li><a href="/PackagePage"><i class="fa fa-circle-o"></i> Packages</a></li>
                  <li><a href="/ServicePage"><i class="fa fa-circle-o"></i> Services</a></li>
              </ul>
            </li>
...
<script src="v/dist/js/demo.js"></script>
<!-- fullCalendar 2.2.5 -->
      ...
      ({
        ...
        success:function(response){
          response.forEach(function(data){
            $eventDetails = data[ss][0]['eventName'];
            $eventDetails = data[ss][0]['eventDate'];
          })
        }
      });
  $(function () {
