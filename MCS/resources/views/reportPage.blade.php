      ...
      <section class="content">
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <a style="width: 120px; height: 80px;" onclick="getReservation();" class="btn btn-app" type="submit">
                  <i class="fa fa-print" ></i> Yearly Transactions
            </a>
            <a style="width: 120px; height: 80px;" onclick="getReservation();" class="btn btn-app">
