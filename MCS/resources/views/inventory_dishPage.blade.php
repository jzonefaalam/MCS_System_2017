...
<!-- Content Wrapper. Contains page content -->
    ...
    <!-- Content Header (Page header) -->
      ...
      <!-- End Modals-->
        ...
        <!-- Update Dish Modal-->
        <form  id="asdasdsad" role="form" method="POST" action="EditDishPage" class="form-horizontal editDishValidator">
        ...
        <div class="panel-body">
          <form id="addDish" role="form" method="POST" action="/DishPage" class="form-horizontal addDishValidator">
                {!! csrf_field() !!}
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <table class="table table-stripped table-bordered dataTable" id="table1">
              <thead>
                <tr>
              ...
              <tbody>
                @foreach($dishData as $dishDetail)
                <tr>
                  <td><img src="{{ asset('images/' . $dishDetail->dishImage) }}"  style="width:150px;height:100px;" /></td>
                  <td>{{ $dishDetail->dishName }}</td>
                  <td>{{ $dishDetail->dishCost }}</td>
                  <td>{{ $dishDetail->dishTypeName }}</td>
                  <td>
                  
                  <?php if (( $dishDetail->dishAvailability )==0): ?> 
                      <div class="btn-group">
                      ...
                      <li>
                        <a data-toggle="modal" data-target="#enableDishModal" onclick="editdishget(this.name);" name="{{$dishDetail->dishID}}">Enable</a>
                      </li>
                      </ul>
                      </div>
                  <?php endif ?>

                  <?php if (( $dishDetail->dishAvailability )==1): ?> 
                      <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                      <li>
                        <a data-toggle="modal" data-target="#disableDishModal" onclick="editdishget(this.name);" name="{{$dishDetail->dishID}}">Disable</a>
                      </li>
                      </ul>
                      </div>
                  <?php endif ?>
...
<script>
  $(function () {
    ...
    $('.addDishValidator').bootstrapValidator({
