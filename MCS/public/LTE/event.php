...
<html>
  ...
  <body class="hold-transition skin-black sidebar-mini">
    ...
    if($message == 9) {
      echo "<script> swal('Data insertion failed!', 'Event is already existing!', 'error'); </script>";
    }
            ...
            <li class="treeview">
              <a href="#">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="event.php"><i class="fa fa-circle"></i> Event</a></li>
    ...
    <!-- Content Header (Page header) -->
      ...
      <section class="content">
        <div class="box box-primary">
          ...
          <div class="box-body">
            <table class="table table-stripped table-bordered">
              ...
              <tbody>
                <?php
                  ...
                  while($row=mysqli_fetch_array($result)):
                    ...
                    $eventDescription=$row['eventTypeDescription'];
                    $eventAvail=$row['eventTypeAvailability'];
                ?>
                <tr>
              ...
              data-id="<?php echo $eventTypeID; ?>" 
							data-name="<?php echo $eventName; ?>" 
							data-desc="<?php echo $eventDescription; ?>" 
							onclick=" 
                $('#editEventTypeID').val($(this).data('id'));
                $('#editEventTypeName').val($(this).data('name'));
                $('#tempName').val($(this).data('name'));  
								$('#editEventTypeDesc').val($(this).data('desc'));  								
								$('#editEventModal').modal('show')" 
							data-toggle="modal"><i class="fa fa-wrench"></i> Update</a>
					
                   <a class="btn btn-danger btn-sm" data-toggle="modal" href="#deleteModal<?php echo $row['eventTypeID'];?>"><i class="fa fa-trash fa-fw"></i> Delete</a>
                 </td>
                 <td width="100px">
                  <?php
                    if($eventAvail==0){
                    ?>
                      <a class="btn btn-success btn-sm" data-toggle="modal" href="#enableModal<?php echo $row['eventTypeID'];?>"><i class="fa fa-trash fa-fw"></i> Enable</a>
                    <?php
                    } else{ 
                    ?>
                      <a class="btn btn-danger btn-sm" data-toggle="modal" href="#disableModal<?php echo $row['eventTypeID'];?>"><i class="fa fa-trash fa-fw"></i> Disable</a>
                    <?php
                      }
                    ?>
                 </td>
                ...
                <div class="modal fade" id="disableModal<?php echo $row['eventTypeID']?>">
                        ...
                        <div class="modal-body">
                          <div class="form-group" style="display: none;">
                            ...
                            <div class="col-sm-5 input-group">
                              ...
                              <input type="text" class="form-control" name="eventTypeID" value="<?php echo $row['eventTypeID']?>" readonly="">
                            </div>
                          </div>
                ...
                <!-- End Modals-->
                 ...
                 <!-- Disable Package Modal-->
                <div class="modal fade" id="enableModal<?php echo $row['eventTypeID']?>">
                  <div class="modal-dialog">
                    <div class="modal-content">
                ...
                <!-- Delete Event Modal-->
                <div class="modal fade" id="deleteModal<?php echo $row['eventTypeID']?>">
                  <div class="modal-dialog">
                    <div class="modal-content">
          ...
          <!-- /.box -->
               ...
               <div class="modal fade" id="editEventModal">
                 <div class="modal-dialog"><form id = "editEventForm" role="form" method="POST" action="editItems.php" class="form-horizontal">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-group" style="display: none;">
                            ...
                            <div class="col-sm-6 input-group">
                                ...
                                <input type="text" class="form-control" name="editEventTypeID" id="editEventTypeID" value="<?php echo $row['eventTypeID']?>" readonly="">
                            </div>
                          </div>
        ...
        <div class="panel-body">
          <form id="addEventForm" role="form" method="POST" action="addItems.php" class="form-horizontal">
              ...
              editEventTypeName: {
                validators: {
				  ...
				  regexp: /^[0-9a-zA-Z]+([-'@\s][0-9a-zA-Z]+)*$/,
                    message: 'Please specify a valid name of event.'
                  },
                  notEmpty: {
                    message: 'Please supply the event name.'
                  },
