...
include "dbcon.php";
$addLocationName = $connect->real_escape_string($_POST['addLocationName']);

// Check its existence (for example, execute a query from the database) ...
$isAvailable = true; // or false
$query = "SELECT locationName FROM locationtbl WHERE locationName = '$addLocationName' and locationStatus=1";
