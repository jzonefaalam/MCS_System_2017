...
include "dbcon.php";
$addEquipmentName = $connect->real_escape_string($_POST['addEquipmentName']);

// Check its existence (for example, execute a query from the database) ...
$isAvailable = true; // or false
$query = "SELECT equipmentName FROM equipmenttbl WHERE equipmentName = '$addEquipmentName' and equipmentStatus=1";
