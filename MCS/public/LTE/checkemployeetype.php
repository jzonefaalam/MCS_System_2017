...
include "dbcon.php";
$addEmployeeTypeName = $connect->real_escape_string($_POST['addEmployeeType']);

// Check its existence (for example, execute a query from the database) ...
$isAvailable = true; // or false
$query = "SELECT employeeTypeName FROM employeetypetbl WHERE employeeTypeName = '$addEmployeeTypeName' and employeeTypeStatus=1";
