...
include "dbcon.php";
$editServiceName = $connect->real_escape_string($_POST['editServiceName']);

// Check its existence (for example, execute a query from the database) ...
$isAvailable = true; // or false
$query = "SELECT serviceName FROM servicetbl WHERE serviceName = '$editServiceName' and serviceStatus=1";
